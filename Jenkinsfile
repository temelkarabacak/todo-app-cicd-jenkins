pipeline{
    ...
    environment {
        ...
        APP_REPO_NAME = "dw-repo/dw-todo-app"
    }
     ...
     stages{ 
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'dw', disableHostKeyChecking: true, installation: 'ansible', inventory: 'inventory_aws_ec2.yml', playbook: 'docker-project.yaml'
             }
        }
